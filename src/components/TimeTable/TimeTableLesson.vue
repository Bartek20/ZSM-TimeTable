...
<template>
  ...
  >
    ...
    <div class="row">
      ...
      <div
        v-else-if="!lessonData.columns.left.id && lessonData.columns.left.name"
      >
      ...
      <div
        v-else-if="
          !lessonData.columns.right.id && lessonData.columns.right.name
        "
      >
  ...
  <span class="lessonOldData" v-else>
    <span class="subject" v-if="data.groupName"
      >{{ lessonData.subject.short }} ({{ data.groupName }})</span
    >
    ...
    <span
      v-else-if="!lessonData.columns.left.id && lessonData.columns.left.name"
      >{{ lessonData.columns.left.name }}</span
    >
    <span v-else>-</span>
    &nbsp;
    <!-- Column #2 -->
    ...
    >
    <span
      v-else-if="!lessonData.columns.right.id && lessonData.columns.right.name"
      >{{ lessonData.columns.right.name }}</span
    >
    <span v-else>-</span>
    <br />
  </span>
